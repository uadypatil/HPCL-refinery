        ...
        <div class="card mx-auto">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-sm-4"><span class="card-title text-center text-white h1">Add Refinary</span>
                    </div>
                    <div class="col-sm-3">
                    </div>
                    <div class="col-sm-1 ">        
            ...
            <div class="card-body bg-light">
                <form method="post" action ="updaterefinary.php" enctype="multipart/form-data">
                    <!-- <div class="row"> -->
                        ...
                        <div class="row mb-5 mt-3">
                            ...
                            <div class="col-sm-2 mb-2"><button type="submit" class="form-control btn btn-primary" name="update" id="update">submit</div>
